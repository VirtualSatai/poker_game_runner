...
class testObservation(unittest.TestCase):
    ...
    def test_methods_headsup(self):
        ...
        self.assertEquals(obs.get_asked_amount(), 5)
        ...
        self.assertEquals(obs.get_asked_amount(), 40)
        ...
        self.assertEquals(obs.get_asked_amount(), 900)
    ...
    def test_methods_3way(self):
        ...
        self.assertEquals(obs.get_max_raise(), 1000-5)
        self.assertEquals(obs.get_max_spent(), 10)
        self.assertEquals(obs.get_asked_amount(), 10)
        ...
        self.assertEquals(obs.get_max_raise(), 1000-5)
        self.assertEquals(obs.get_max_spent(), 50)
        self.assertEquals(obs.get_asked_amount(), 45)
        ...
        self.assertEquals(obs.get_max_raise(), 1)
        self.assertEquals(obs.get_max_spent(), 1000)
        self.assertEquals(obs.get_asked_amount(), 950)
